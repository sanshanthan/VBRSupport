...
public static class NotAvailableCustomersDA
{

    public static List<CustomerModel> GetNotAvailableCustomers(string Connection)
    {
        ...
        sql += "where No_ in (Select No_ from @CustomerNos) ";
        #endregion SQL
